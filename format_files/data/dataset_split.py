...
if __name__ == '__main__':
    ...
    data_path = r'D:\HightWeightProject\data\h_w'

    initial_data_frame = pd.read_pickle(fr'{data_path}/data.pkl')
    ...
    train_data_frame.to_pickle(rf'{data_path}/train.pkl')

    test_data_frame.to_pickle(rf'{data_path}/test.pkl')

    valid_data_frame.to_pickle(rf'{data_path}/valid.pkl')
